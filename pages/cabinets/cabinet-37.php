<?php
$pageTitle = 'Кабинет 37 VIP';
$pageDescription = 'VIP кабинет 37 площадью 32 м² для аренды в Минске. Вместимость до 15 человек. Подходит для тренингов, семинаров и деловых встреч.';
$canonicalUrl = '/pages/cabinets/cabinet-37.php';
    ...
    <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto">
            <div class="flex items-center gap-3 mb-4">
                ...
                <span class="text-white">Кабинет 37</span>
            </div>
            <div class="flex items-center gap-4 mb-4">
                <h1 class="text-4xl md:text-5xl font-bold">Кабинет 37</h1>
                <span class="bg-amber-500 text-white px-4 py-2 rounded-full text-sm font-semibold">VIP</span>
            </div>
            <p class="text-xl text-gray-300">Просторный VIP-кабинет для групповой работы и мероприятий</p>
        </div>
    </div>
</section>
            ...
            <div class="grid md:grid-cols-2 gap-12">
                ...
                <div>
                    <div class="rounded-xl overflow-hidden shadow-lg">
                        <img src="/assets/cabinet-37/img.png" alt="Кабинет 37" class="w-full h-auto object-cover">
                    </div>
                </div>
                    ...
                    <div class="space-y-4 mb-8">
                        <div class="flex items-center gap-4 p-4 bg-blue-50 rounded-lg">
                            ...
                            <div>
                                ...
                                <div class="text-gray-600">32 м²</div>
                            </div>
                        </div>
                        <div class="flex items-center gap-4 p-4 bg-blue-50 rounded-lg">
                            <svg class="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div>
                                ...
                                <div class="text-gray-600">До 15 человек</div>
                            </div>
                        </div>
                        <div class="flex items-center gap-4 p-4 bg-blue-50 rounded-lg">
                            <svg class="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div>
                                ...
                                <div class="text-gray-600">VIP-1</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-slate-50 p-6 rounded-xl mb-6">
                        <div class="space-y-3">
                            <div class="flex justify-between items-center pb-3 border-b border-slate-200">
                                <span class="text-gray-700">Групповая аренда (до 10 ч/нед)</span>
                                <span class="text-2xl font-bold text-slate-800">35₽/ч</span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-gray-700">Индивидуальная аренда</span>
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="text-center p-6">
                    ...
                    <p class="text-gray-600 text-sm">Групповые занятия</p>
                </div>
                <div class="text-center p-6">
                    <div class="text-4xl mb-4">📊</div>
                    <h3 class="font-semibold text-lg mb-2">Семинаров</h3>
                    <p class="text-gray-600 text-sm">Обучающие мероприятия</p>
                </div>
                <div class="text-center p-6">
                    <div class="text-4xl mb-4">🤝</div>
                    <h3 class="font-semibold text-lg mb-2">Деловых встреч</h3>
                    <p class="text-gray-600 text-sm">Переговоры и презентации</p>
                </div>
                <div class="text-center p-6">
                    <div class="text-4xl mb-4">🧘</div>
...
<section class="py-16 bg-gray-50">
    <div class="container mx-auto px-4">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid md:grid-cols-3 gap-6">
                <a href="/pages/cabinets/cabinet-28.php" class="office-card bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition block">
                    ...
                    <div class="p-4">
                        <h3 class="font-bold text-lg mb-2">Кабинет 28</h3>
                        <p class="text-gray-600 text-sm">21 м² • до 8 человек</p>
                        <p class="text-blue-600 font-semibold mt-2">от 20₽/ч</p>
                    </div>
                </a>
